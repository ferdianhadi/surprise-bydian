  ...
  return (
    ...
    <div className="w-[400px]  h-screen flex flex-col items-center justify-center">
      ...
      <div id="card" className={`${cardClass}`} onClick={toggleCard}>     
        <div id="card-inside">
          <div className="wrap">
            <p>Happy Birthday, Hesty Sayang!</p>
            <p>Semoga sehat selalu, diberi rezeki yang melimpah, dipermudah segala urusannya.</p>
            <p>
              I hope you have a very blessed birthday!
            </p>
            <p>
             Jangan pernah bosen sama aku yaa sayang, bareng bareng terus kita yaa :*.
            </p>
            <p>
              I love you so much!!!
            </p>
            <p className="signed">Ferdian</p>
          </div>
        </div>
